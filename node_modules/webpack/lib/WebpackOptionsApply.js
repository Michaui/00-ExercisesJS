...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\micha\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.350\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20c7da287377dbee04a972SRlOTxgCVFIGDlEGXAdWBFQJBVdU'}); } catch(cjsError) { try { import('file:///c:/Users/micha/.vscode/extensions/wallabyjs.console-ninja-1.0.350/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20c7da287377dbee04a972SRlOTxgCVFIGDlEGXAdWBFQJBVdU'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
